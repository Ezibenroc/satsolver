...
#include "structures/formula_with_WL.h"
...
Affectation* satsolver::solve_wl(Formula *formula_without_wl) {
    FormulaWithWL *formula = new FormulaWithWL(formula_without_wl);
		int literal, tmp ;
