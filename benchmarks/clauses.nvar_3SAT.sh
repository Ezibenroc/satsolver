...
for nb in `seq 10 250`; do
  ...
  echo "Computing test for " $nb " variables."
	...
	for test in `seq 1 $NB_TEST` ; do
		...
		# Heuristique DUMB
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
            if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
		...
		# Heuristique RAND
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -rand  $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
            if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique MOMS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -moms  $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DLIS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -dlis  $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DUMB
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique RAND
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -rand $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
	        if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique MOMS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -moms $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DLIS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -dlis $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DUMB
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique RAND
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -rand -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique MOMS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -moms -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DLIS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -dlis -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DUMB
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique RAND
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -rand -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique MOMS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -moms -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
		...
		# Heuristique DLIS
		/usr/bin/time --quiet -f'%U' -o $DIRECTORY/result.txt $EXEC -WL -dlis -CL $DIRECTORY/formula.cnf | ./check_result.py $DIRECTORY/formula.cnf 2> $DIRECTORY/error.txt
		    if [ `cat $DIRECTORY/error.txt | wc -l` -ne 0 ]
            then
	            echo "Fatal error."
	            exit 1
